...
/// Generate Daily Insight Use Case
class GenerateDailyInsight {
  final AiRepository _repository;

  GenerateDailyInsight(this._repository);

  Future<Either<AiFailure, AiInsight>> call({
    required Map<String, String> userData,
  }) {
    return _repository.generateDailyInsight(userData: userData);
  }
}
